...
public class UpdateVerificationQuiz extends HttpServlet {
  ...
  private static final String VERIFICATION_QUESTION_TEMPLATE =
      "%s <div class=\"label label-info\">%s</div>";
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    Question verificationQuestion = new Question(
        quizId,
        new Text(
            String.format(
                VERIFICATION_QUESTION_TEMPLATE, verificationQuestionText, answer.getText())),
        QuestionKind.MULTIPLE_CHOICE_COLLECTION);
