...
public class Quizz extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getQuestionInstance".
   *
   * This request holds the parameters needed by the the quizz server.  After setting any optional
   * parameters, call the {@link GetQuestionInstance#execute()} method to invoke the remote operation.
   *
   * @param quiz
   * @param mid
   * @return the request
   */
  public GetQuestionInstance getQuestionInstance(java.lang.String quiz, java.lang.String mid) throws java.io.IOException {
    GetQuestionInstance result = new GetQuestionInstance(quiz, mid);
    initialize(result);
    return result;
  }

  public class GetQuestionInstance extends QuizzRequest<us.quizz.www.crowdquiz.entities.quizz.model.QuizQuestionInstance> {

    private static final String REST_PATH = "quizquestioninstance/quiz/{quiz}/mid/{mid}";

    /**
     * Create a request for the method "getQuestionInstance".
     *
     * This request holds the parameters needed by the the quizz server.  After setting any optional
     * parameters, call the {@link GetQuestionInstance#execute()} method to invoke the remote
     * operation. <p> {@link GetQuestionInstance#initialize(com.google.api.client.googleapis.services.
     ...
     * @since 1.13
     */
    protected GetQuestionInstance(java.lang.String quiz, java.lang.String mid) {
      super(Quizz.this, "GET", REST_PATH, null, us.quizz.www.crowdquiz.entities.quizz.model.QuizQuestionInstance.class);
      this.quiz = com.google.api.client.util.Preconditions.checkNotNull(quiz, "Required parameter quiz must be specified.");
    ...
    @Override
    public GetQuestionInstance setAlt(java.lang.String alt) {
      return (GetQuestionInstance) super.setAlt(alt);
    }

    @Override
    public GetQuestionInstance setFields(java.lang.String fields) {
      return (GetQuestionInstance) super.setFields(fields);
    }

    @Override
    public GetQuestionInstance setKey(java.lang.String key) {
      return (GetQuestionInstance) super.setKey(key);
    }

    @Override
    public GetQuestionInstance setOauthToken(java.lang.String oauthToken) {
      return (GetQuestionInstance) super.setOauthToken(oauthToken);
    }

    @Override
    public GetQuestionInstance setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetQuestionInstance) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetQuestionInstance setQuotaUser(java.lang.String quotaUser) {
      return (GetQuestionInstance) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetQuestionInstance setUserIp(java.lang.String userIp) {
      return (GetQuestionInstance) super.setUserIp(userIp);
    }
    ...
    public GetQuestionInstance setQuiz(java.lang.String quiz) {
      this.quiz = quiz;
      return this;
    }
    ...
    public GetQuestionInstance setMid(java.lang.String mid) {
      this.mid = mid;
      return this;
    }

    @Override
    public GetQuestionInstance set(String parameterName, Object value) {
      return (GetQuestionInstance) super.set(parameterName, value);
    }
  }
