...
data="{ \"quizID\": $QUIZ_ID, \"text\": \"How would you say <a target=\\\"_blank\\\" href=\\\"http://freebase.com$f3\\\">$f1</a> in Russian?\", \"weight\": 1, \"answers\": [{ \"text\": \"$f2\", \"kind\": \"input_text\", \"isGold\": true }]}"
