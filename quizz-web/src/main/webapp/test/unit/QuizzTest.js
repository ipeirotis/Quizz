describe('full test', function() {
        ...
        var $httpBackend = {};
        var listControllerScope, quizControllerScope, feedbackControllerScope, summaryControllerScope;
        var routeParams = {};
        var questions = [];
    ...
    //list controller
                ...
                $controller('QuizController', {$scope: quizControllerScope, $routeParams : routeParams});
                ...
                //check all questions
          for(var i=0; i<workflowService.getQuestions().calibration.length; i++){
                quizControllerScope.answerQuestion(1);
            $httpBackend.flush();
            expect(workflowService.getUserFeedbacks().length).toEqual(i + 1);
            expect(workflowService.getNumOfCorrectAnswers()).toEqual(i + 1);
