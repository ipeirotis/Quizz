...
<link rel="stylesheet" type="text/css" href="css/bootstrap-custom.css?v=20140224154514">
<link rel="stylesheet" type="text/css" href="css/style.css?v=20140224154514">
...
<script src="js/all.js?v=20140224154514" type="text/javascript"></script>
			...
			<ul class="nav navbar-nav">
				...
				<li data-match-route="/reports/([A-Za-z0-9]+)" class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="#/reports/answers">Answers</a></li>
