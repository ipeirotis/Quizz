...
curl $API_URL/insertQuestion --header 'Content-Type: application/json' --data '{ "quizID": "'$QUIZ_ID'", "text": "Did you hear the joke about the statistician who drowned while wading across a river whose average depth was three feet? What did the statistician forget to take into account?", "feedback": "Standard deviation is a measure of variability around a mean, in this case variations in the depth of a river.", "kind": "MULTIPLE_CHOICE_CALIBRATION", "weight": 1, "answers": [{ "text": "The standard deviation", "kind": "GOLD" }, { "text": "The correlation coefficient", "kind": "INCORRECT" }, { "text": "The median", "kind": "INCORRECT" }, { "text": "Inferential statistics", "kind": "INCORRECT" }] }'
...
do
   ...
   curl $API_URL/insertQuestion --header 'Content-Type: application/json' --data  '{ "quizID": "'$QUIZ_ID'", "text": "Calibration Question '$i'", "kind": "MULTIPLE_CHOICE_CALIBRATION", "weight": 1, "answers": [{ "text": "Answer 1 - gold", "kind": "GOLD" }, { "text": "Answer 2", "kind": "INCORRECT" }, { "text": "Answer 3", "kind": "INCORRECT" }, { "text": "Answer 4", "kind": "INCORRECT" }] }'
done

for i in {1..10}
do
   echo "Adding collection question #$i"
   curl $API_URL/insertQuestion --header 'Content-Type: application/json' --data  '{ "quizID": "'$QUIZ_ID'", "text": "Collection Question '$i'", "kind": "MULTIPLE_CHOICE_COLLECTION", "weight": 1, "answers": [{ "text": "Answer 1 - silver", "kind": "SILVER", "probability": 0.75 }, { "text": "Answer 2", "kind": "INCORRECT" }, { "text": "Answer 3", "kind": "INCORRECT" }, { "text": "Answer 4", "kind": "INCORRECT" }] }'
done
