...
public class QuizEndpoint extends BaseCollectionEndpoint<Quiz> {
	...
	public List<Question> getNextQuestions(@Named("quiz") String quiz,
			@Nullable @Named("num") Integer num) {
		if (num == null)
			num = QUESTION_PACKAGE_SIZE;
		Set<Question> questions = QuizesOperations.getNextQuizQuestions(quiz,
				num);
