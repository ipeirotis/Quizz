...
if (user.getsTreatment("showMessage")) { 
	%>$('#showMessage').show();  $('#showMessage').delay(3000).fadeOut();
	<%
} else {
	%>$('#showMessage').hide();
	<%
...
if (user.getsTreatment("showCorrect")) { 
	%>$('#showCorrect').show();  $('#showCorrect').delay(3000).fadeOut();
	<%
} else {
	%>$('#showCorrect').hide();
	<%
...
if (user.getsTreatment("showCrowdAnswers")) { 
	%>$('#showCrowdAnswers').show(); $('#showCrowdAnswers').delay(3000).fadeOut();
	<%
} else {
