...
<body>
	...
	<script>
	$('#silver_file').qtip({content: 'A file with Freebase mids, the potential answers associated with each mid, the probability associated with each answer, and the source reporting this probability.'});
	</script>

	<script>
		$(document).ready(function() {
			// bind 'myForm' and provide a simple callback function 
			$('#uploadSilverAnswers').ajaxForm(function() {
				alert("Silver answers added!");
